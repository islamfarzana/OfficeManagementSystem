        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mr-auto text-center">
                    ...
                    <a class="d-block" href="mailto:contact@yourwebsite.com">info@oms.com</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer class="bg-light py-5">
        <div class="container">
            ...
            <div class="small text-center" style="color: #b1b1b1">
                Office Management System - Developed by <a href="https://github.com/islamfarzana">Farzana Islam</a>
            </div>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
